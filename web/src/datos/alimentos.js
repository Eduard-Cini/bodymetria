...
export const RANGOS_MICROS = [
  ...
  { clave: 'magnesio', tipo: 'min', hombres: 400, mujeres: 310 },
  { clave: 'zinc', tipo: 'min', hombres: 11, mujeres: 8 },
  { clave: 'folato', tipo: 'min', hombres: 400, mujeres: 400 },
...
export const NUTRIENTES = [
  ...
  { clave: 'magnesio', nombre: 'Magnesio', unidad: 'mg', decimales: 0 },
  { clave: 'zinc', nombre: 'Zinc', unidad: 'mg', decimales: 1 },
  { clave: 'folato', nombre: 'Folato', unidad: 'µg', decimales: 0 },
...
// Micronutrientes que se resumen en los paneles (recetas y alimentos del día).
export const MICROS_APP = [
  'fibra', 'calcio', 'hierro', 'magnesio', 'zinc', 'folato', 'potasio', 'sodio',
  'vitC', 'vitD', 'b12',
]

// Magnesio (mg), zinc (mg) y folato (µg) POR RACIÓN para los alimentos que más
// aparecen en las recetas (aprox. USDA). Se fusionan en ALIMENTOS abajo; los que
// no están aquí quedan en 0 (subestima, se avisa en el panel).
const MICROS_EXTRA = {
  frijol: { magnesio: 60, zinc: 1.0, folato: 128 },
  lenteja: { magnesio: 36, zinc: 1.3, folato: 179 },
  garbanzo: { magnesio: 39, zinc: 1.3, folato: 141 },
  haba: { magnesio: 32, zinc: 0.9, folato: 55 },
  soya: { magnesio: 74, zinc: 1.0, folato: 46 },
  tofu: { magnesio: 30, zinc: 0.8, folato: 15 },
  avena: { magnesio: 40, zinc: 1.1, folato: 8 },
  arroz: { magnesio: 10, zinc: 0.4, folato: 45 },
  arrozint: { magnesio: 21, zinc: 0.6, folato: 4 },
  tortilla: { magnesio: 22, zinc: 0.5, folato: 30 },
  amaranto: { magnesio: 65, zinc: 0.8, folato: 22 },
  pan: { magnesio: 25, zinc: 0.6, folato: 40 },
  panbimboint: { magnesio: 25, zinc: 0.6, folato: 40 },
  pasta: { magnesio: 12, zinc: 0.6, folato: 45 },
  papa: { magnesio: 21, zinc: 0.3, folato: 15 },
  camote: { magnesio: 25, zinc: 0.3, folato: 6 },
  elote: { magnesio: 26, zinc: 0.5, folato: 30 },
  espinaca: { magnesio: 47, zinc: 0.3, folato: 116 },
  brocoli: { magnesio: 11, zinc: 0.3, folato: 84 },
  jitomate: { magnesio: 11, zinc: 0.2, folato: 18 },
  zanahoria: { magnesio: 8, zinc: 0.2, folato: 12 },
  nopal: { magnesio: 52, zinc: 0.3, folato: 3 },
  calabacita: { magnesio: 18, zinc: 0.3, folato: 24 },
  champinon: { magnesio: 9, zinc: 0.5, folato: 17 },
  kale: { magnesio: 30, zinc: 0.4, folato: 40 },
  berro: { magnesio: 21, zinc: 0.1, folato: 9 },
  lechuga: { magnesio: 13, zinc: 0.2, folato: 64 },
  aguacate: { magnesio: 10, zinc: 0.2, folato: 27 },
  huevo: { magnesio: 6, zinc: 0.6, folato: 22 },
  clara: { magnesio: 7, zinc: 0, folato: 2 },
  pollo: { magnesio: 8, zinc: 0.3, folato: 2 },
  bistec: { magnesio: 6, zinc: 1.4, folato: 2 },
  molida: { magnesio: 6, zinc: 1.4, folato: 2 },
  cerdo: { magnesio: 8, zinc: 0.7, folato: 0 },
  pescado: { magnesio: 12, zinc: 0.2, folato: 3 },
  atun: { magnesio: 15, zinc: 0.3, folato: 2 },
  salmon: { magnesio: 9, zinc: 0.2, folato: 8 },
  sardina: { magnesio: 12, zinc: 0.4, folato: 3 },
  camaron: { magnesio: 11, zinc: 0.3, folato: 12 },
  higado: { magnesio: 5, zinc: 1.2, folato: 65 },
  panela: { magnesio: 8, zinc: 1.0, folato: 5 },
  oaxaca: { magnesio: 8, zinc: 1.1, folato: 5 },
  manchego: { magnesio: 8, zinc: 1.0, folato: 4 },
  mozzarella: { magnesio: 6, zinc: 0.9, folato: 2 },
  jamonpavo: { magnesio: 8, zinc: 0.6, folato: 2 },
  lechedesc: { magnesio: 27, zinc: 1.0, folato: 12 },
  lecheentera: { magnesio: 24, zinc: 0.9, folato: 12 },
  lechesoya: { magnesio: 39, zinc: 0.5, folato: 24 },
  yogurt: { magnesio: 28, zinc: 1.4, folato: 17 },
  yogurtlight: { magnesio: 25, zinc: 1.2, folato: 15 },
  almendra: { magnesio: 32, zinc: 0.4, folato: 6 },
  cacahuate: { magnesio: 25, zinc: 0.4, folato: 30 },
  nuez: { magnesio: 16, zinc: 0.3, folato: 3 },
  pepitas: { magnesio: 40, zinc: 0.8, folato: 6 },
  cremacacahuate: { magnesio: 25, zinc: 0.4, folato: 12 },
  chia: { magnesio: 34, zinc: 0.5, folato: 5 },
  ajonjoli: { magnesio: 32, zinc: 0.7, folato: 9 },
  platano: { magnesio: 16, zinc: 0.1, folato: 12 },
  fresa: { magnesio: 13, zinc: 0.2, folato: 24 },
  naranja: { magnesio: 10, zinc: 0.1, folato: 30 },
  mango: { magnesio: 9, zinc: 0.1, folato: 43 },
  papaya: { magnesio: 21, zinc: 0.1, folato: 37 },
  guayaba: { magnesio: 22, zinc: 0.2, folato: 49 },
}

ALIMENTOS.forEach((a) => Object.assign(a, MICROS_EXTRA[a.id] || {}))
