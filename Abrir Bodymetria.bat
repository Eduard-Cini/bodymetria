...
powershell -NoProfile -Command "Start-Process -FilePath \"$env:LOCALAPPDATA\Android\Sdk\emulator\emulator.exe\" -WorkingDirectory \"$env:LOCALAPPDATA\Android\Sdk\emulator\" -ArgumentList '-avd','bodymetria','-no-boot-anim','-gpu','swiftshader_indirect'"
echo.
